...
class data_tranformation:
    ...
    def transform_data(self):
        ...
        logging.info(f"saving transformation at {self.data_tranformation_config.transformation_filepath}")
        save_object(self.data_tranformation_config.transformation_filepath,self.preprocessor)


if __name__=='__main__':

    data_tranformation_obj = data_tranformation(train_data_path = 'data_artifacts/train_data.csv',
                                                test_data_path = 'data_artifacts/test_data.csv',
                                                target_col='math_score')
    train,test = data_tranformation_obj.transform()
